...
pacman::p_load(tidyverse, glue, here, janitor, sf, tmap, exactextractr, terra, RColorBrewer, ggplot2, openxlsx2)
...
path1 <- glue("{data_path}/n3_rainfall.nc")

if (file.exists(path1) == T){#if the file exists read it in
  ...
  rain <- rast(glue("{data_path}/monthly_rainfall.nc"))
