...
pacman::p_load(dplyr, tidyr, glue, here, sf, tmap, exactextractr, RColorBrewer, ggplot2, ncdf4, lubridate)

#install/load the custom RcTools package
#pak::pak("add-am/RcTools")
library(RcTools)

#define the current year that is being targeted
current_fyear <- 2025

#build the data path and output path variables
data_path <- here("data/sst/")
output_path <- here("outputs/sst/")
...
sst_mean_region <- tibble(exact_extract(test, n3_marine, fun = "mean"))
