...
pacman::p_load(dplyr, glue, here, sf, tmap, exactextractr, terra, RColorBrewer, ggplot2, openxlsx2, stars)
...
output_path <- here(glue("outputs/rainfall/{script_year}/"))
...
if (file.exists(data_name)){
  rain_data <- st_read(data_name)
} else {
  rain_data <- rainfall_extract(n3_region)
  write_stars(rain_data, data_name)
}
